...
var sablono$util$ToString$to_str$dyn_45125 = (function (x){
...
return sablono$util$ToString$to_str$dyn_45125(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_45130 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_45130(x);
}
});
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq45078){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45078));
}));
...
var vec__45085 = cljs.core.name(k).split("-");
var seq__45086 = cljs.core.seq(vec__45085);
var first__45087 = cljs.core.first(seq__45086);
var seq__45086__$1 = cljs.core.next(seq__45086);
var first_word = first__45087;
var words = seq__45086__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__45094){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__45098,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__45098;
}
} else {
