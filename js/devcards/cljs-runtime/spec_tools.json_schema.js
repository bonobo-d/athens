...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.json-schema","default","spec-tools.json-schema/default",-2093938695)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52970 = cljs.core.get_global_hierarchy;
return (fexpr__52970.cljs$core$IFn$_invoke$arity$0 ? fexpr__52970.cljs$core$IFn$_invoke$arity$0() : fexpr__52970.call(null));
})());
...
var map__52973 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
...
var map__52975 = spec_tools.parse.parse_spec(form);
var map__52975__$1 = (((((!((map__52975 == null))))?(((((map__52975.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52975.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52975):map__52975);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52975__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__52977 = type;
...
var vec__52978 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52978,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52978,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52978,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52978,(3),null);
...
var vec__52981 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52981,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52981,(1),null);
...
var extra_info = (function (){var G__52984 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52984,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__52984;
}
})();
