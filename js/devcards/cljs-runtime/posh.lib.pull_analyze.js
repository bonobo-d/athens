...
return cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23969_SHARP_){
if(cljs.core.coll_QMARK_(p1__23969_SHARP_)){
return (posh.lib.pull_analyze.insert_dbid.cljs$core$IFn$_invoke$arity$1 ? posh.lib.pull_analyze.insert_dbid.cljs$core$IFn$_invoke$arity$1(p1__23969_SHARP_) : posh.lib.pull_analyze.insert_dbid.call(null,p1__23969_SHARP_));
} else {
return p1__23969_SHARP_;
}
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__24028,pull_pattern,ent_id){
var map__24029 = p__24028;
var map__24029__$1 = (((((!((map__24029 == null))))?(((((map__24029.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24029.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__24029):map__24029);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24029__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24029__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24029__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__24031 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24031.cljs$core$IFn$_invoke$arity$2 ? fexpr__24031.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__24031.call(null,db,ent_id));
})());
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__24039,pull_pattern,ent_ids){
var map__24040 = p__24039;
var map__24040__$1 = (((((!((map__24040 == null))))?(((((map__24040.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24040.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__24040):map__24040);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24040__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24040__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24040__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
...
var fexpr__24046 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24046.cljs$core$IFn$_invoke$arity$2 ? fexpr__24046.cljs$core$IFn$_invoke$arity$2(db,p1__24034_SHARP_) : fexpr__24046.call(null,db,p1__24034_SHARP_));
}),ent_ids);
