...
var entity_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__24009_SHARP_){
return ((cljs.core.map_QMARK_(p1__24009_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),p1__24009_SHARP_)));
}),pull_pattern);
var val_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__24010_SHARP_){
return ((posh.lib.pull_analyze.reverse_lookup_QMARK_(p1__24010_SHARP_)) || (posh.lib.pull_analyze.ref_QMARK_(schema,p1__24010_SHARP_)));
}),entity_keys);
...
})())?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__24014_SHARP_){
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4(schema,ref_pull,p1__24014_SHARP_,refs_only_QMARK_) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,ref_pull,p1__24014_SHARP_,refs_only_QMARK_));
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__24038 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24038.cljs$core$IFn$_invoke$arity$2 ? fexpr__24038.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__24038.call(null,db,ent_id));
})());
...
var fexpr__24061 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24061.cljs$core$IFn$_invoke$arity$2 ? fexpr__24061.cljs$core$IFn$_invoke$arity$2(db,p1__24044_SHARP_) : fexpr__24061.call(null,db,p1__24044_SHARP_));
}),ent_ids);
...
return posh.lib.pull_analyze.generate_affected_tx_datoms_for_pull(schema,p1__24047_SHARP_);
