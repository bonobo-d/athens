...
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44900,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44900,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__44903){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44904__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44904__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44904__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44904__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44904__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__44907 = (new goog.Uri());
G__44907.setScheme(cljs.core.name((function (){var or__4126__auto__ = scheme;
...
G__44907.setDomain(server_name);

G__44907.setPort(server_port);

G__44907.setPath(uri);

G__44907.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__44909_SHARP_,p2__44908_SHARP_){
var vec__44910 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__44908_SHARP_,/:\s+/);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44910,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44910,(1),null);
if(((clojure.string.blank_QMARK_(k)) || (clojure.string.blank_QMARK_(v)))){
return p1__44909_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__44909_SHARP_,clojure.string.lower_case(k),v);
}
