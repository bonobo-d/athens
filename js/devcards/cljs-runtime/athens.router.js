...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__54762){
var vec__54763 = p__54762;
var seq__54764 = cljs.core.seq(vec__54763);
var first__54765 = cljs.core.first(seq__54764);
var seq__54764__$1 = cljs.core.next(seq__54764);
var ___$1 = first__54765;
var route = seq__54764__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__54766,p__54767){
var map__54768 = p__54766;
var map__54768__$1 = (((((!((map__54768 == null))))?(((((map__54768.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54768.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54768):map__54768);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54768__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__54769 = p__54767;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54769,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54769,(1),null);
...
var result__50929__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__50928__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__50929__auto__ = reitit.frontend.easy.push_state;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__50929__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__50929__auto__;
})(),(function (){var opts__50928__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__50929__auto__ = route;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__50929__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"route","route",1970422836,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__50929__auto__;
})());
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__50929__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"apply","apply",-1334050276,null),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Symbol(null,"route","route",1970422836,null)),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));

return result__50929__auto__;
}catch (e54773){var e = e54773;
throw e;
}}):(function (route){
