...
if((cljs.core.peek(index) < ((function (){var G__55845 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__55845) : instaparse.auto_flatten_seq.true_count.call(null,G__55845));
})() - (1)))){
...
while(true){
if((!((coll__$1 == null)))){
var G__55876 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55877 = cljs.core.next(coll__$1);
unmixed_hash = G__55876;
coll__$1 = G__55877;
continue;
} else {
return unmixed_hash;
...
var G__55881 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55882 = cljs.core.next(v);
acc = G__55881;
v = G__55882;
continue;
} else {
var G__55884 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
