...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40134 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40134(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40135 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40135(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40138 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40138(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40144 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40144(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40150 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40150(h);
}
});
...
var cljs$core$async$impl$protocols$Handler$commit$dyn_40158 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40158(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40161 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40161(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40166 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40166(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40167 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40167(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40168 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40168(b);
}
});
