...
var fexpr__51804 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__51804.cljs$core$IFn$_invoke$arity$1 ? fexpr__51804.cljs$core$IFn$_invoke$arity$1(type) : fexpr__51804.call(null,type));
});
...
var G__51832 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__51832;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__51805 = spec_tools.impl.normalize_symbol(x);
var G__51806 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__51805,G__51806) : spec_tools.parse.parse_form.call(null,G__51805,G__51806));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__51807 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__51808 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__51807,G__51808) : spec_tools.parse.parse_form.call(null,G__51807,G__51808));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__51833 = cljs.spec.alpha.form(x);
x = G__51833;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__51809 = spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x);
var G__51810 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__51809,G__51810) : spec_tools.parse.parse_form.call(null,G__51809,G__51810));
} else {
...
var G__51811 = parse_data;
var G__51811__$1 = (((G__51811 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__51811));
var G__51811__$2 = (((G__51811__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__51811__$1));
var G__51811__$3 = (((G__51811__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__51811__$2));
var G__51811__$4 = (((G__51811__$3 == null))?null:cljs.core.seq(G__51811__$3));
if((G__51811__$4 == null)){
return null;
} else {
return cljs.core.set(G__51811__$4);
}
}
});
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__51812 = cljs.core.get_global_hierarchy;
return (fexpr__51812.cljs$core$IFn$_invoke$arity$0 ? fexpr__51812.cljs$core$IFn$_invoke$arity$0() : fexpr__51812.call(null));
})());
...
var map__51817 = spec_tools.impl.parse_keys(form);
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51817__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51817__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51817__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51817__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51817__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__51819 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__51819__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51819,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__51819);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51819__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__51819__$1;
}
}));
...
var map__51820 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51820__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__51822 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51822__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__51824){
var vec__51825 = p__51824;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51825,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51825,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51825,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__51828){
...
var ___$1 = first__51831;
var values = seq__51830__$1;
