...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61448,action,ex){
...
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61449__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__61451 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61451) : callback.call(null,G__61451));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61452,p__61453){
var map__61454 = p__61452;
...
var state = map__61454__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61454__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var action = map__61455__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61455__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__61458 = type;
var G__61458__$1 = (((G__61458 instanceof cljs.core.Keyword))?G__61458.fqn:null);
switch (G__61458__$1) {
case "repl/invoke":
var map__61459 = action;
...
var G__61462 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61462) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61462));
}catch (e61461){var ex = e61461;
...
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61463){
...
var state = map__61464__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61464__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61466 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61466.cljs$core$IFn$_invoke$arity$1 ? fexpr__61466.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61466.call(null,state));
} else {
var map__61467 = cljs.core.first(actions);
...
var action = map__61467__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61467__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__61474 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61475 = (function (res){
var req = this;
var map__61479 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__61479__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61479__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__61481 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61481) : callback.call(null,G__61481));
} else {
...
var G__61476 = "POST";
var G__61477 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61478 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61474,G__61475,G__61476,G__61477,G__61478);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61470,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61470,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61483){
var vec__61484 = p__61483;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61484,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61484,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61469){
var self__ = this;
var G__61469__$1 = this;
return (new cljs.core.RecordIter((0),G__61469__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__61487 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61487(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61471,other61472){
var self__ = this;
var this61471__$1 = this;
return (((!((other61472 == null)))) && ((this61471__$1.constructor === other61472.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61471__$1.ws,other61472.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61471__$1.state_ref,other61472.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61471__$1.__extmap,other61472.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61469){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61488 = cljs.core.keyword_identical_QMARK_;
var expr__61489 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61491 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61492 = expr__61489;
return (pred__61488.cljs$core$IFn$_invoke$arity$2 ? pred__61488.cljs$core$IFn$_invoke$arity$2(G__61491,G__61492) : pred__61488.call(null,G__61491,G__61492));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61469,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61493 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61494 = expr__61489;
return (pred__61488.cljs$core$IFn$_invoke$arity$2 ? pred__61488.cljs$core$IFn$_invoke$arity$2(G__61493,G__61494) : pred__61488.call(null,G__61493,G__61494));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61469,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61469),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61469){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61469,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61473){
var extmap__4478__auto__ = (function (){var G__61495 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61473,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61473)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61495);
} else {
return G__61495;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61473),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61473),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61496 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61496);
...
var map__61497 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61497__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
