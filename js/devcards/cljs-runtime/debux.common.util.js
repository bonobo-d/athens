...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50391_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50391_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50390_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50390_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50392_SHARP_){
return (((p1__50392_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50392_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50396,mapping){
...
var state = map__50397__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50397__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50397__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50397__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50393_SHARP_){
if((p1__50393_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50393_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50432 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50433 = clojure.zip.next(loc);
loc = G__50433;
continue;
}
}
...
var len__4736__auto___50444 = arguments.length;
var i__4737__auto___50445 = (0);
while(true){
if((i__4737__auto___50445 < len__4736__auto___50444)){
args__4742__auto__.push((arguments[i__4737__auto___50445]));

var G__50446 = (i__4737__auto___50445 + (1));
i__4737__auto___50445 = G__50446;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50403){
var vec__50404 = p__50403;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50404,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50401){
var G__50402 = cljs.core.first(seq50401);
var seq50401__$1 = cljs.core.next(seq50401);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50402,seq50401__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50407_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50407_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50409_50448 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50410_50449 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50411_50450 = true;
var _STAR_print_fn_STAR__temp_val__50412_50451 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50411_50450);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50412_50451);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50410_50449);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50409_50448);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50408_SHARP_){
return debux.common.util.prepend_bars(p1__50408_SHARP_,indent_level);
...
var G__50453 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50452;
acc = G__50453;
continue;
} else {
if(typeof f === 'string'){
var G__50454 = cljs.core.next(opts__$1);
var G__50455 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50454;
acc = G__50455;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50456 = cljs.core.nnext(opts__$1);
var G__50457 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50456;
acc = G__50457;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50458 = cljs.core.next(opts__$1);
var G__50459 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50458;
acc = G__50459;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50415 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50415.cljs$core$IFn$_invoke$arity$1 ? fexpr__50415.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50415.call(null,f));
})())){
var G__50460 = cljs.core.next(opts__$1);
var G__50461 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50460;
acc = G__50461;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50416 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50416.cljs$core$IFn$_invoke$arity$1 ? fexpr__50416.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50416.call(null,f));
})())){
var G__50464 = cljs.core.nnext(opts__$1);
var G__50465 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50464;
acc = G__50465;
continue;
} else {
...
var G__50467 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50466;
acc = G__50467;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50418){
var vec__50419 = p__50418;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50419,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50419,(1),null);
...
var G__50423 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50422 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50427 = quoted_form;
var G__50428 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50427,G__50428) : debux.common.util.remove_d.call(null,G__50427,G__50428));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50470__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50429 = quoted_form;
var G__50430 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50429,G__50430) : debux.common.util.remove_d.call(null,G__50429,G__50430));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__50470 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__50472__i = 0, G__50472__a = new Array(arguments.length -  0);
while (G__50472__i < G__50472__a.length) {G__50472__a[G__50472__i] = arguments[G__50472__i + 0]; ++G__50472__i;}
  arg = new cljs.core.IndexedSeq(G__50472__a,0,null);
} 
return G__50470__delegate.call(this,arg);};
G__50470.cljs$lang$maxFixedArity = 0;
G__50470.cljs$lang$applyTo = (function (arglist__50473){
var arg = cljs.core.seq(arglist__50473);
return G__50470__delegate(arg);
});
...
var G__50474 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50474;
continue;
} else {
...
var G__50475 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50475;
continue;
} else {
var G__50476 = clojure.zip.next(loc);
loc = G__50476;
continue;
