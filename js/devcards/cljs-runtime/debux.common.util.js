...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50386_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50386_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50385_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50385_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50387_SHARP_){
return (((p1__50387_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50387_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50392,mapping){
...
var state = map__50393__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50393__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50393__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50393__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50390_SHARP_){
if((p1__50390_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50390_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var len__4736__auto___50441 = arguments.length;
var i__4737__auto___50442 = (0);
while(true){
if((i__4737__auto___50442 < len__4736__auto___50441)){
args__4742__auto__.push((arguments[i__4737__auto___50442]));

var G__50443 = (i__4737__auto___50442 + (1));
i__4737__auto___50442 = G__50443;
continue;
} else {
}
break;
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50397){
var G__50398 = cljs.core.first(seq50397);
var seq50397__$1 = cljs.core.next(seq50397);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50398,seq50397__$1);
}));
...
var _STAR_print_newline_STAR__orig_val__50406_50444 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50407_50445 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50408_50446 = true;
var _STAR_print_fn_STAR__temp_val__50409_50447 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50408_50446);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50409_50447);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50407_50445);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50406_50444);
}
...
var G__50450 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50449;
acc = G__50450;
continue;
} else {
...
var G__50452 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50451;
acc = G__50452;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50453 = cljs.core.nnext(opts__$1);
var G__50454 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50453;
acc = G__50454;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50455 = cljs.core.next(opts__$1);
var G__50456 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50455;
acc = G__50456;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50412 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
...
var G__50458 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50457;
acc = G__50458;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50413 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50413.cljs$core$IFn$_invoke$arity$1 ? fexpr__50413.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50413.call(null,f));
})())){
var G__50459 = cljs.core.nnext(opts__$1);
var G__50460 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50459;
acc = G__50460;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50461 = cljs.core.next(opts__$1);
var G__50462 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50461;
acc = G__50462;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50414){
var vec__50415 = p__50414;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50415,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50415,(1),null);
...
return (function() { 
var G__50465__delegate = function (arg){
...
var G__50465 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__50466__i = 0, G__50466__a = new Array(arguments.length -  0);
while (G__50466__i < G__50466__a.length) {G__50466__a[G__50466__i] = arguments[G__50466__i + 0]; ++G__50466__i;}
  arg = new cljs.core.IndexedSeq(G__50466__a,0,null);
} 
return G__50465__delegate.call(this,arg);};
G__50465.cljs$lang$maxFixedArity = 0;
G__50465.cljs$lang$applyTo = (function (arglist__50467){
var arg = cljs.core.seq(arglist__50467);
return G__50465__delegate(arg);
});
G__50465.cljs$core$IFn$_invoke$arity$variadic = G__50465__delegate;
return G__50465;
})()
;
});
...
var G__50471 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50471;
continue;
} else {
...
var G__50472 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50472;
continue;
} else {
var G__50473 = clojure.zip.next(loc);
loc = G__50473;
continue;
