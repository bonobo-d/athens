...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51339_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51339_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51338_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51338_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51345_SHARP_){
return (((p1__51345_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51345_SHARP_) == null)));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51348_SHARP_){
if((p1__51348_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51348_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__51429 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51430 = clojure.zip.next(loc);
loc = G__51430;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51383){
var vec__51384 = p__51383;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51384,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51379){
var G__51380 = cljs.core.first(seq51379);
var seq51379__$1 = cljs.core.next(seq51379);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51380,seq51379__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51387_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51387_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__51389_51458 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51390_51459 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51391_51460 = true;
var _STAR_print_fn_STAR__temp_val__51392_51461 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51391_51460);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51392_51461);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51390_51459);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51389_51458);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51388_SHARP_){
return debux.common.util.prepend_bars(p1__51388_SHARP_,indent_level);
...
var G__51463 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51462;
acc = G__51463;
continue;
} else {
...
var G__51465 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51464;
acc = G__51465;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51466 = cljs.core.nnext(opts__$1);
var G__51467 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51466;
acc = G__51467;
continue;
} else {
...
var G__51469 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51468;
acc = G__51469;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51403 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__51403.cljs$core$IFn$_invoke$arity$1 ? fexpr__51403.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51403.call(null,f));
})())){
var G__51471 = cljs.core.next(opts__$1);
var G__51472 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51471;
acc = G__51472;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51408 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__51408.cljs$core$IFn$_invoke$arity$1 ? fexpr__51408.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51408.call(null,f));
})())){
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__51409){
var vec__51410 = p__51409;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51410,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51410,(1),null);
...
var fexpr__51416 = (function (){var fexpr__51418 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__51418.cljs$core$IFn$_invoke$arity$1 ? fexpr__51418.cljs$core$IFn$_invoke$arity$1(form) : fexpr__51418.call(null,form));
})();
