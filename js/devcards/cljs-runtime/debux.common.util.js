...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50350_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50350_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50349_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50349_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50351_SHARP_){
return (((p1__50351_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50351_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50356,mapping){
...
var state = map__50357__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50357__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50357__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50357__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50354_SHARP_){
if((p1__50354_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50354_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50414 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50415 = clojure.zip.next(loc);
loc = G__50415;
continue;
}
}
...
var len__4736__auto___50423 = arguments.length;
var i__4737__auto___50424 = (0);
while(true){
if((i__4737__auto___50424 < len__4736__auto___50423)){
args__4742__auto__.push((arguments[i__4737__auto___50424]));

var G__50425 = (i__4737__auto___50424 + (1));
i__4737__auto___50424 = G__50425;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50384){
var vec__50385 = p__50384;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50385,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50382){
var G__50383 = cljs.core.first(seq50382);
var seq50382__$1 = cljs.core.next(seq50382);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50383,seq50382__$1);
}));
...
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50388_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50390_50426 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50391_50427 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50392_50428 = true;
var _STAR_print_fn_STAR__temp_val__50393_50429 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50392_50428);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50393_50429);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50391_50427);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50390_50426);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50389_SHARP_){
return debux.common.util.prepend_bars(p1__50389_SHARP_,indent_level);
...
var G__50431 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50430;
acc = G__50431;
continue;
} else {
if(typeof f === 'string'){
var G__50432 = cljs.core.next(opts__$1);
var G__50433 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50432;
acc = G__50433;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50434 = cljs.core.nnext(opts__$1);
var G__50435 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50434;
acc = G__50435;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50436 = cljs.core.next(opts__$1);
var G__50437 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50436;
acc = G__50437;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50398 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50398.cljs$core$IFn$_invoke$arity$1 ? fexpr__50398.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50398.call(null,f));
})())){
var G__50438 = cljs.core.next(opts__$1);
var G__50439 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50438;
acc = G__50439;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50399 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50399.cljs$core$IFn$_invoke$arity$1 ? fexpr__50399.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50399.call(null,f));
})())){
var G__50440 = cljs.core.nnext(opts__$1);
var G__50441 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50440;
acc = G__50441;
continue;
} else {
...
var G__50443 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50442;
acc = G__50443;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50400){
var vec__50401 = p__50400;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50401,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50401,(1),null);
...
var G__50405 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50404 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50404.cljs$core$IFn$_invoke$arity$1 ? fexpr__50404.cljs$core$IFn$_invoke$arity$1(G__50405) : fexpr__50404.call(null,G__50405));
});
...
return (function() { 
var G__50444__delegate = function (arg){
...
var G__50444 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__50445__i = 0, G__50445__a = new Array(arguments.length -  0);
while (G__50445__i < G__50445__a.length) {G__50445__a[G__50445__i] = arguments[G__50445__i + 0]; ++G__50445__i;}
  arg = new cljs.core.IndexedSeq(G__50445__a,0,null);
} 
return G__50444__delegate.call(this,arg);};
G__50444.cljs$lang$maxFixedArity = 0;
G__50444.cljs$lang$applyTo = (function (arglist__50446){
var arg = cljs.core.seq(arglist__50446);
return G__50444__delegate(arg);
});
G__50444.cljs$core$IFn$_invoke$arity$variadic = G__50444__delegate;
return G__50444;
})()
;
});
...
var G__50447 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50447;
continue;
} else {
...
var G__50448 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50448;
continue;
} else {
var G__50449 = clojure.zip.next(loc);
loc = G__50449;
continue;
