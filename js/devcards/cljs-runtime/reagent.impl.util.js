...
var vec__30842 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__30844;
var parts = seq__30843__$1;
...
var vec__30848 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str__$1,/-/);
var seq__30849 = cljs.core.seq(vec__30848);
var first__30850 = cljs.core.first(seq__30849);
var seq__30849__$1 = cljs.core.next(seq__30849);
var start = first__30850;
var parts = seq__30849__$1;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.str,start,cljs.core.map.cljs$core$IFn$_invoke$arity$2(reagent.impl.util.capitalize,parts));
}
});
...
var self__ = this;
var self__ = this;
var G__30869 = (arguments.length - (1));
switch (G__30869) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args30863){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args30863)));
}));
...
args_arr__4757__auto__.push((arguments[i__4737__auto___31010]));

var G__31011 = (i__4737__auto___31010 + (1));
i__4737__auto___31010 = G__31011;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.util.class_names.cljs$lang$applyTo = (function (seq30930){
...
args_arr__4757__auto__.push((arguments[i__4737__auto___31040]));
...
/** @this {Function} */
(reagent.impl.util.merge_props.cljs$lang$applyTo = (function (seq30940){
var G__30941 = cljs.core.first(seq30940);
var seq30940__$1 = cljs.core.next(seq30940);
var G__30942 = cljs.core.first(seq30940__$1);
var seq30940__$2 = cljs.core.next(seq30940__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30941,G__30942,seq30940__$2);
}));
