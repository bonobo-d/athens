 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__61747){
...
var G__61752 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__61753 = now_seen_events;
var fexpr__61751 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__61751.cljs$core$IFn$_invoke$arity$2 ? fexpr__61751.cljs$core$IFn$_invoke$arity$2(G__61752,G__61753) : fexpr__61751.call(null,G__61752,G__61753));
...
var G__61754 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61755 = "async-flow: got bad value for :when - ";
var G__61756 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61754,G__61755,G__61756) : re_frame.core.console.call(null,G__61754,G__61755,G__61756));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__61757){
var map__61758 = p__61757;
var map__61758__$1 = (((((!((map__61758 == null))))?(((((map__61758.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61758.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61758):map__61758);
var rule = map__61758__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61758__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61758__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61758__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61758__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61758__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61758__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61758__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__61760 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61761 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__61762 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61760,G__61761,G__61762) : re_frame.core.console.call(null,G__61760,G__61761,G__61762));
} else {
var G__61763 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__61763__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61763,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__61763);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61763__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__61763__$1;
}
...
var map__61764 = rule;
var map__61764__$1 = (((((!((map__61764 == null))))?(((((map__61764.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61764.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61764):map__61764);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61764__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61764__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__61766 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61767 = "async-flow: dispatch-fn must return a seq of events ";
var G__61768 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61766,G__61767,G__61768) : re_frame.core.console.call(null,G__61766,G__61767,G__61768));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__61769){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61770__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61770__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61770__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61770__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__61772,p__61773){
var map__61774 = p__61772;
var map__61774__$1 = (((((!((map__61774 == null))))?(((((map__61774.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61774.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61774):map__61774);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61774__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61775 = p__61773;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61775,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61775,(1),null);
var event_v = vec__61775;
var pred__61779 = cljs.core._EQ_;
var expr__61780 = event_type;
if(cljs.core.truth_((function (){var G__61782 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__61783 = expr__61780;
return (pred__61779.cljs$core$IFn$_invoke$arity$2 ? pred__61779.cljs$core$IFn$_invoke$arity$2(G__61782,G__61783) : pred__61779.call(null,G__61782,G__61783));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__61784 = db;
var G__61785 = cljs.core.PersistentHashSet.EMPTY;
var G__61786 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__61784,G__61785,G__61786) : set_state.call(null,G__61784,G__61785,G__61786));
...
var vec__61787 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61787,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61787,(1),null);
var map__61790 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61790__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61790__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__61792 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61792,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61792,(1),null);
...
var G__61795 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61795) : re_frame.core.dispatch.call(null,G__61795));
});
var G__61796_61798 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__61797_61799 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__61796_61798,G__61797_61799) : re_frame.core.reg_fx.call(null,G__61796_61798,G__61797_61799));
