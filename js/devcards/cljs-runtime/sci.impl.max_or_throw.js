...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57767 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57767(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57749 = (n - (1));
var G__57750 = cljs.core.rest(s);
var G__57751 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57749,G__57750,G__57751) : sci.impl.max_or_throw.take_STAR_.call(null,G__57749,G__57750,G__57751));
})());
} else {
return null;
}
