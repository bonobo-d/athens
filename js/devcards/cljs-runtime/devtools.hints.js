...
var temp__5733__auto___20811 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20811)){
var seen_errors_20812 = temp__5733__auto___20811;
if(cljs.core.truth_(seen_errors_20812.has(self))){
} else {
seen_errors_20812.add(self);

var temp__5735__auto___20813 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20813)){
var sense_20814 = temp__5735__auto___20813;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20814)].join(''));
} else {
}
}
} else {
